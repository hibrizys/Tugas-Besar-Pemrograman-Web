		...
		<div class="container">
			<div class="row">
				<div class="col-12 col-md-6">
					<div class="faq">
						<h3 class="faq__title"><i class="icon ion-ios-information-circle-outline"></i> Why is a Video is not loading?</h3>
					...
					<div class="faq">
						<h3 class="faq__title"><i class="icon ion-ios-information-circle-outline"></i> Why isn't there a HD version of this video?</h3>
					...
					<div class="faq">
						<h3 class="faq__title"><i class="icon ion-ios-information-circle-outline"></i> Why is the sound distorted?</h3>
					...
					<div class="faq">
						<h3 class="faq__title"><i class="icon ion-ios-information-circle-outline"></i> Why is the Video stuttering, buffering or randomly stopping?</h3>
					...
					<div class="faq">
						<h3 class="faq__title"><i class="icon ion-ios-information-circle-outline"></i> When I change the quality of a video, nothing happens.</h3>
				...
				<div class="col-12 col-md-6">
					<div class="faq">
						<h3 class="faq__title"><i class="icon ion-ios-information-circle-outline"></i> Why isn't the video starting at the beginning?</h3>
					...
					<div class="faq">
						<h3 class="faq__title"><i class="icon ion-ios-information-circle-outline"></i> How do I make the Video go Fullscreen?</h3>
					...
					<div class="faq">
						<h3 class="faq__title"><i class="icon ion-ios-information-circle-outline"></i> What Browsers are supported?</h3>
					...
					<div class="faq">
						<h3 class="faq__title"><i class="icon ion-ios-information-circle-outline"></i> How do you handle my privacy?</h3>
						<p class="faq__text">Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).</p>
					</div>

					<div class="faq">
						<h3 class="faq__title"><i class="icon ion-ios-information-circle-outline"></i> How can I contact you?</h3>
						<p class="faq__text">The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English.</p>
					</div>
				</div>
			</div>
