			...
			<div class="row row--grid">
				...
				<div class="col-12">
					<div class="main__title">
						...
						<a href="<?= base_url('admin/addItem'); ?>" class="main__title-link">add item</a>
					</div>
				</div>
				<!-- end main title -->
					...
					<div class="dashbox">
						<div class="dashbox__title">
							...
							<div class="dashbox__wrap">
								...
								<a class="dashbox__more" href="<?= base_url('admin/catalog'); ?>">View All</a>
							</div>
						</div>
				...
				<div class="col-12 col-xl-6">
					<div class="dashbox">
						<div class="dashbox__title">
							...
							<div class="dashbox__wrap">
								<a class="dashbox__refresh" href="#"><i class="icon ion-ios-refresh"></i></a>
								<a class="dashbox__more" href="<?= base_url('admin/users'); ?>">View All</a>
							</div>
						</div>
				...
				<div class="col-12 col-xl-6">
					<div class="dashbox">
						<div class="dashbox__title">
							...
							<div class="dashbox__wrap">
								<a class="dashbox__refresh" href="#"><i class="icon ion-ios-refresh"></i></a>
								<a class="dashbox__more" href="<?= base_url('admin/reviews'); ?>">View All</a>
							</div>
						</div>
